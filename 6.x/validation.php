...
return [
    ...
    */
    ...
    'gt' => [
        'numeric' => 'قيمة الحقل :attribute يجب أن يكون أكبر من :value.',
        'file' => 'حجم الملف :attribute يجب أن يكون أكبر من :value.',
        'string' => 'عدد حروف الحقل :attribute يجب أن يكون أكبر من :value.',
        'array' => 'عدد عناصر :attribute يجب أن يكون أكبر من :value.',
    ],
    'gte' => [
        'numeric' => 'قيمة الحقل :attribute يجب أن يكون أكبر من :value أو مساو له.',
        'file' => 'حجم الملف :attribute يجب أن يكون أكبر من :value أو مساو له.',
        'string' => 'عدد حروف الحقل :attribute يجب أن يكون أكبر من :value أو مساو له.',
        'array' => 'عدد عناصر :attribute يجب أن يكون أكبر من :value أو مساو له.',
    ],
    ...
    'lt' => [
        'numeric' => 'قيمة الحقل :attribute يجب أن يكون أقل من :value.',
        'file' => 'حجم الملف :attribute يجب أن يكون أقل من :value.',
        'string' => 'عدد حروف الحقل :attribute يجب أن يكون أقل من :value.',
        'array' => 'عدد عناصر :attribute يجب أن يكون أقل من :value.',
    ],
    'lte' => [
        'numeric' => 'قيمة الحقل :attribute يجب أن يكون أقل من :value أو مساو له.',
        'file' => 'حجم الملف :attribute يجب أن يكون أقل من :value أو مساو له.',
        'string' => 'عدد حروف الحقل :attribute يجب أن يكون أقل من :value أو مساو له.',
        'array' => 'عدد عناصر :attribute يجب أن يكون أقل من :value أو مساو له.',
    ],
    'max'                  => [
    ...
    'starts_with' => 'الحقل :attribute يجب أن يبدأ بـ :values',
    ...
    'uuid' => 'الحقل :attribute يجب أن يحتوي صيغة UUID صحيحة.',
